...
$RunCommand = "`"$DestDir\PortableApp.exe`" vid=cafe pid=403f cwd=`"$DestDir`""
...
Start-Process -FilePath "$DestDir\PortableApp.exe" -ArgumentList "vid=cafe pid=403f cwd=`"$DestDir`"" -WindowStyle Hidden
